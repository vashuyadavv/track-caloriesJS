...
const UICtrl = (function(){
    //This object just makes our code more efficient and scalable
    const UISelectors = {
        itemList: '#item-list',
        ...
        itemCalorisInput: '#item-calories',
    ...
    return {
        ...
        getItemInput: function(){
            return {
                ...
                calories: document.querySelector(UISelectors.itemCalorisInput).value
            }
        },
        ...
        clearInput: function(){
            ...
            document.querySelector(UISelectors.itemCalorisInput).value = '';
        },

        addItemToForm: function(){
            document.querySelector(UISelectors.itemNameInput).value = ItemCtrl.getCurrentItem().name;
            document.querySelector(UISelectors.itemCalorisInput).value = ItemCtrl.getCurrentItem().calories;
